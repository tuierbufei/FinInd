...
window.onload = function () {
    ...
    function tradeChart(container, report, market, stkcd, attempt){
        ...
        new highStockChart('container',report, retTrade, crrentData);
    }
    ...
    $('.typeahead').bind('typeahead:select', function(ev, suggestion) {
        ...
        // render stock chart
        tradeChart($('#stockChartContainer'), $("#report"), suggestion.market, stkcd, attempt);
