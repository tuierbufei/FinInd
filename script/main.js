...
window.onload = function () {
    ...
    $('.typeahead').bind('typeahead:select', function (ev, suggestion) {
        ...
        // render stock chart
        renderStockChart(suggestion.market.toUpperCase() + stkcd, 3, 365 * 2);
    ...
    function createTradeChart(container, report, market, stkcd, attempt) {
        ...
        new highStockChart('stockChartContainer', report, retTrade, crrentData);
    }
